...
public interface IWarehouseService
{
    ...
    public Task<Response<WarehouseDto>> CreateAsync(CreateWarehouseDto dto, long companyId,
        CancellationToken ct = default);

    public Task<Response<WarehouseDto>> UpdateAsync(long id, UpdateWarehouseDto dto, long companyId,
        CancellationToken ct = default);
