...
{
    public Task<Customer?> GetByTaxIdAsync(string taxId, CancellationToken ct = default);
    ...
    public Task<bool> ExistsByTaxIdAsync(string taxId, long? excludeId = null, CancellationToken ct = default);
    public Task<IReadOnlyList<CustomerAssignment>> GetAssignmentsByUserAsync(long userId, int? dayOfWeek = null, CancellationToken ct = default);
