    ...
    ILogger<DataSeedService> logger) : IDataSeedService
{
    ...
    [
        ...
        new("warehousetypes.view", "Ver tipos de almacén"),
        new("warehousetypes.manage", "Gestionar tipos de almacén"),
        ...
        new("smartinventories.view", "Ver inventarios inteligentes"),
        new("smartinventories.manage", "Gestionar inventarios inteligentes"),
    ...
    [
        new(
            ...
            [
                ...
                "inventory.manage",
                "warehousetypes.view",
                "warehousetypes.manage",
                "warehouses.view",
                "warehouses.manage",
                "suppliers.view",
                "suppliers.manage",
                "smartinventories.view",
                "smartinventories.manage",
                "reports.view",
                "audit.view",
                "accesses.view",
                "accesses.manage",
